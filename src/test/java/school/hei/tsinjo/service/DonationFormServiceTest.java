...
public class DonationFormServiceTest {
    ...
    void getPrefilledDonationForm_multipleEvents_returnsLatestForUser() {
        ...
        Payment payment1 = new Payment("p1", 500, PspType.ORANGE_MONEY, "PSP1", PaymentStatus.CONFIRMED, Instant.now().minusSeconds(3600));
        ...
        Payment payment2 = new Payment("p2", 1000, PspType.ORANGE_MONEY, "PSP2", PaymentStatus.CONFIRMED, Instant.now());
